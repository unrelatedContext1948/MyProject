...
router.post("/submitAdText", express.json(), authenticate, async (req, res) => {
  ...
  if (req.user.role === "admin") {
    let dbResult = await songsAdBreak.addAdBreak(username, adBreakText, "approved");
    let newAdBreakId = dbResult;
    newAdBreakId = dbResult.lastInsertRowid;
    console.log(`Start the audio generation of the ad break ${newAdBreakId}...`);
    await songsAdBreak.generateAudio(newAdBreakId);
